...
impl GlutinWindowContext {
    ...
    unsafe fn new(
        ...
        */
        ...
        // Graphite: older Windows Intel drivers expose desktop GL 3.1 but neither GL 3.3
        // nor GLES. Try desktop compatibility GL before the upstream GLES fallback.
        ...
        let desktop_compatibility_attributes = glutin::context::ContextAttributesBuilder::new()
        ...
        let gl_context = match gl_context_result {
            ...
            Err(err) => {
                ...
                unsafe {
                    gl_config
                        .display()
                        .create_context(&gl_config, &desktop_compatibility_attributes)
